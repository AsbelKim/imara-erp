<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800">New Department</h2></x-slot>
    <div class="py-8 max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="{{ route('hr.departments.store') }}" class="space-y-4">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <x-text-input id="code" name="code" class="mt-1 block w-full" value="{{ old('code') }}" required placeholder="e.g. HR, FIN, ICT" />
